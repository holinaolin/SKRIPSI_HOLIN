...
if __name__ == "__main__":
	motor = MotorControl(device="COM5") #(kanan)
	motor2 = MotorControl(device="COM3") #(kiri)
	
	# motor.set_id(1)
	motor.set_drive_mode(_id=1, _mode=2)
	motor2.set_drive_mode(_id=1, _mode=2)
	motor.send_rpm(1, 5) # 5 rpm
	motor2.send_rpm(1, 5) # 5 rpm